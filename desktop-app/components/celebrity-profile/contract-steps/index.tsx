...
const ContractSteps = ({ publicContracts }: ContractStepsProps) => {
  ...
  return (
    ...
    >
      <h2>Cómo tener un video personalizado de tu Famoso favorito.</h2>
      <div className={styles.ContractStepsDescription}>
        <div className={styles.ContractStep}>
          <div className={styles.ContractStepTitle}>
            <CommentAlt></CommentAlt> <p>Personaliza el mensaje de tu video.</p>
          </div>

          <span>
            Especifica la celebración, dedicatoria o motivo del video. Puedes
        ...
        <div className={styles.ContractStep}>
          <div className={styles.ContractStepTitle}>
            <ShoppingBag /> <p>Completa el proceso de compra.</p>
          </div>
          <span>
            Elige el método de pago que prefieras y completa el proceso. Los
            pagos son 100% seguros. ¡En 7 días o menos recibirás tu video!
          </span>
        </div>
        <div className={styles.ContractStep}>
          <div className={styles.ContractStepTitle}>
            <SurpriseBox /> <p>¡Disfruta la experiencia!</p>
          </div>
          <span>
            Una vez que tu video esté listo te notificaremos para que corras a
