export const occasionsData = {
  BIRTHDAY: {
    ...
    title: 'Cumpleaños',
    messages: [
		'Hola (Famoso)! Soy la fan más grande tuya, me encanta tu trabajo y no me he perdido ningún show. Este viernes cumplo 32 años y me gustaría que me enviaras un mensaje de felicitación por mi cumpleaños, me harías muy feliz.',
		'Hola (Famoso)! A (<<PARA>>) y a mí nos encanta tu trabajo, (<<PARA>>) está cumpliendo años y me encantaría que le enviaras un saludo por sus 25 años. Siempre nos acordamos de ese chiste que mencionaste en el capítulo de inicio de tu serie, sería bueno si pudieras mencionarlo en el video. ',
    ],
  },
  LOVE: {
    icon: 'fa-heart',
  ...
  JOKE: {
    ...
    title: 'Broma',
    messages: [
      'Hola (Famoso)! Me encantan tus chistes, no me he perdido ninguno de tus shows, me gustaría que me envíes un video haciendo alguna de tus bromas, sé que me va a encantar.',
      'Hola (Famoso)! A (<<PARA>>) le encantan tus chistes, no se ha perdido ninguno de tus shows, me gustaría que le envíes un video haciendo alguna de tus bromas, sé que a ella le va a encantar.',
    ],
  },
  HOPE: {
    icon: 'fa-dove',
