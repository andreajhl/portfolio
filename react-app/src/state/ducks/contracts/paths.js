...
export const GET_CONTRACT_COMMENTS_DATA = `custom-endpoints/${CONTRACT_MODEL}/get-contract-comments-data/`;
export const GET_CONTRACT_COMMENTS = `custom-endpoints/${CONTRACT_MODEL}/get-contract-comments/`;
export const ADD_OR_REMOVE_CONTRACT_LIKE = `custom-endpoints/${CONTRACT_MODEL}/add-or-remove-contract-like/`;
