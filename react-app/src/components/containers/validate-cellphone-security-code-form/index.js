      ...
      <div className="ValidateCellphoneSecurityCodeForm">
        ...
        <div className="mt-4">
          <h6>
            ...
            <b>
              {this.state.dialCode} {this.state.cellphoneNumber}
            </b>
          </h6>
          <button
...
const mapStateToProps = (state) => ({
  ...
  validateSMSSecurityCodeLoading:
    state.authentication.validateSMSSecurityCodeReducer.loading,
  validateSMSSecurityCodeCompleted:
    state.authentication.validateSMSSecurityCodeReducer.completed,
  validateSMSSecurityCodeError:
    state.authentication.validateSMSSecurityCodeReducer.error_data.error,
  validateSMSSecurityCodeData:
    state.authentication.validateSMSSecurityCodeReducer.data
});
...
// Export Class
const _ValidateCellphoneSecurityCodeForm = connect(
  mapStateToProps,
  mapDispatchToProps
)(ValidateCellphoneSecurityCodeForm);
