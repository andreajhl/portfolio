...
class SignInWithCellphoneForm extends Component {
  ...
  sendSMSSecurityCode(e) {
    if (!this.props.sendSMSSecurityCodeLoading) {
      ...
      GTM.tagManagerDataLayer("CLICK_ON_SEND_SMS_SECURITY_CODE", data);
    }
  }
    ...
    return (
      <div className="SignInWithCellphoneForm">
        ...
        <p className="instructions">
          Enviaremos un mensaje de texto a este número con un código de
          confirmación
        </p>
        <SignInMethodsForm
          whatsapp={true}
...
// Export Class
const _SignInWithCellphoneForm = connect(
  mapStateToProps,
  mapDispatchToProps
