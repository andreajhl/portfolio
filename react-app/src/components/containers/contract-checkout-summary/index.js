...
class ContractCheckoutSummary extends Component {
  ...
  applyDiscount() {
    ...
    if (this.props.couponData.data.isPercentageDiscount) {
      discountTotal =
        this.props.couponData.data.discount_amount * this.props.price;
    ...
    return (
      <div className="ContractCheckoutSummary">
        <div className="row contract-summary col-lg-12 justify-content-center">
          ...
          <div
            className="col-lg-12 contract-details mx-auto"
                ...
                <>
                  <div className="col-12 ml-0 pl-0 mb-3">
                    <h6 className="text-colored">
                      Para:&nbsp;
                      <span
                        className="font-weight-bold text-with-ellipsis d-inline-block"
                        style={{ width: "80%" }}
                      >
                        {this.props.deliveryTo}
                      </span>
                    ...
                    availableDiscount={
                      this.props.couponData.completed
                        ? {
                            ...
                            isPercentageDiscount: this.props.couponData.data
                              .isPercentageDiscount,
                            discountAmount: this.props.couponData.data
                              .discount_amount
                          }
                        : false
                    }
