...
class ResetPasswordForm extends Component {
  ...
  componentWillReceiveProps(nextProps, nextContext) {
    if (
      nextProps.securityCodeSent === true &&
      this.props.securityCodeSent !== nextProps.securityCodeSent
    ) {
...
const mapStateToProps = (state) => ({
  isLoading:
    state.authentication.resetPasswordReducer.loading ||
  ...
  resetPasswordError:
    state.authentication.resetPasswordReducer.error_data.error,
...
// Export Class
const _ResetPasswordForm = connect(
  mapStateToProps,
  mapDispatchToProps
)(ResetPasswordForm);
