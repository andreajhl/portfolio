...
export const FilterSeccionCountries = ({
  setFilterParam,
  countries,
  queryParams,
  ...
  return (
    <CelebritiesFilter
      buttonLabel={intl.formatMessage(messageForLabelButtonCategoryCountry)}
      modalTitle={intl.formatMessage(messageForModalTitleCategoryCountry)}
