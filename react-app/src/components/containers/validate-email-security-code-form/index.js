  ...
  render() {
    return (
      <div className="ValidateEmailSecurityCodeForm">
        ...
        <div className="mt-4">
          <h6>
            ¿Este no es tu correo? <b>{this.state.email}</b>
          </h6>
          <button
...
const mapStateToProps = (state: any) => ({
  ...
  validateEmailSecurityCodeLoading:
    state.authentication.validateEmailSecurityCodeReducer.loading,
  validateEmailSecurityCodeCompleted:
    state.authentication.validateEmailSecurityCodeReducer.completed,
  validateEmailSecurityCodeError:
    state.authentication.validateEmailSecurityCodeReducer.error_data.error,
  validateEmailSecurityCodeData:
...
// Export Class
const _ValidateEmailSecurityCodeForm = connect(
  mapStateToProps,
  mapDispatchToProps
)(ValidateEmailSecurityCodeForm);
