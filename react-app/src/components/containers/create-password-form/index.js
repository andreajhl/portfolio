    ...
    createPassword(e) {
        if (this.state.password !== this.state.password2) {
            ...
            if (!this.props.isLoading) {
                ...
                this.props.createPassword(data, PATHS.COMPLETE_PROFILE_PATH + "?email=true");
            }
        }
    }
...
const mapStateToProps = (state: any) => ({
    ...
    createPasswordError: state.authentication.createPasswordReducer.error_data.error,
});
...
// Export Class
const _CreatePasswordForm = connect(mapStateToProps, mapDispatchToProps)(CreatePasswordForm);
