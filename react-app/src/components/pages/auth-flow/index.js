...
class AuthFlowPage extends Component {
    ...
    goToSignUp = () => {
        history._pushRoute(ROUTING_PATHS.SIGN_UP_WITH_SPECIFIC_FORM_PATH.replace(":form", "email-form"))
    };


    goToSignIn = () => {
        history._pushRoute(ROUTING_PATHS.SIGN_IN_WITH_SPECIFIC_FORM_PATH.replace(":form", "email-form"))
    };
