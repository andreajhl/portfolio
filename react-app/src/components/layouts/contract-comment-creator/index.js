    ...
    render() {
        return (
            <div className="ContractCommentCreatorLayout">
                <h6 className="font-weight-bold">Agrega un comentario:</h6>
                <textarea className="form-control mb-2" value={this.state.comment} onChange={this.handleInput}/>
...
// Export Class
const _ContractCommentCreatorLayout = connect(mapStateToProps, mapDispatchToProps)(ContractCommentCreatorLayout);
