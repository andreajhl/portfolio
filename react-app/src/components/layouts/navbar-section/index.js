...
class NavbarSectionLayout extends Component {
  ...
  componentDidMount() {
    this.setState(
      {
        showSearch: Boolean(
          new URLSearchParams(history.location.search).get("showInputSearchSm")
        )
      },
      () => this.updateClasses()
    );
    document
      .getElementsByClassName("page-container-children")[0]
    ...
    this.setState(
      ...
      () => {
        ...
        if (this.state.dropdownOpened) {
          document.getElementsByClassName(initialClass)[0].className +=
            " active ";
        } else {
          document.getElementsByClassName(
            initialClass
          )[0].className = initialClass;
        }
      }
    );
  }
          ...
          <nav className="f-navbar">
            ...
            <div className="navbar-1240">
              <div className="f-items d-none d-md-block">
                ...
                <div
                  className={
                    "float-right float-right-lg" +
                    (this.props.hideControls ? " d-none " : "")
                  }
                >
                  {logged === "no" ? (
                    <>
              ...
              >
                ...
                >
                  {logged === "no" || logged === "dummy" ? (
                    <>
                      <div
                        className="col-sm-2 pt-0 ml-0 pl-0 mb-0 pb-0 text-center"
                        style={{ display: "flex" }}
                      >
                        <a
                          className="btn btn-sm mr-3"
                        ...
                        >
                          <i
                            className={
                              "fa fa-search fa-2x" +
                              (this.state.showSearch ? " text-primary " : "")
                            }
                          />
                        </a>
...
// Export Class
const _NavbarSectionLayout = connect(
  mapStateToProps,
  mapDispatchToProps
)(NavbarSectionLayout);
