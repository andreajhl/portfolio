...
function SubscriptionVideoSlideLayout({
  videoUrl,
  videoReference,
  shouldLoadPoster,
  videoIsMuted,
  ...
  return (
    <section className="SubscriptionVideoSlideLayout">
      <div
        className={`SubscriptionVideoSlideLayout__buttons  ${
      ...
      <div className="SubscriptionVideoSlideLayout__media-container">
        {shouldLoadPoster && preload === "none" && !videoIsLoaded ? (
          <img
            className="SubscriptionVideoSlideLayout__poster"
        ...
        <video
          className={`SubscriptionVideoSlideLayout__video  ${
...
SubscriptionVideoSlideLayout.defaultProps = {
...
export { SubscriptionVideoSlideLayout };
