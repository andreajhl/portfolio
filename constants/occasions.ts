...
const occasions: { [key: string]: OccasionType } = {
  ...
  MAKE_SMILE: {
    ...
    title: "Hacer sonreír",
    messages: [
      "¡Hola PLACEHOLDER_FAMOSO_NAME! Te admiro mucho y me gustaría que me mandaras un mensaje que me haga sonreír.",
...
export function getOccasion(occasion: string) {
  const occasionKey = occasions.hasOwnProperty(occasion) ? occasion : "OTHER";

  const contractOccasion = occasions[occasionKey];
