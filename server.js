        ...
        .then((r) => {
            if (r.data.status === "OK") {
                fs.readFile(filePath, 'utf8', function (err, data) {
                    ...
                    data = data.replace(/\$OG_TITLE/g, 'Famosos.com -  Comprar video personalizado de ' + r.data.data.fullName);
                    data = data.replace(/\$OG_TYPE/g, 'website');
                    data = data.replace(/\$OG_URL/g, 'https://www.famosos.com/' + r.data.data.username);
                    data = data.replace(/\$OG_IMAGE/g, r.data.data.avatar);
                    data = data.replace(/\$OG_SITE_NAME/g, 'Famosos.com');
                    data = data.replace(/\$OG_DESCRIPTION/g, "Comprar video personalizado de  " + r.data.data.fullName + " en Famosos.com. Reserva tu video personalizado y disfruta de experiencias únicas.");
                    data = data.replace(/\$OG_VIDEO/g, r.data.data.mainVideo);
                    data = data.replace(/\$OG_VIDEO_URL/g, r.data.data.mainVideo);
                    data = data.replace(/\$OG_VIDEO_SECURE_URL/g, r.data.data.mainVideo);
                    data = data.replace(/\$OG_VIDEO_WITH/g, '400');
...
app.get('/auth/sign-in/email-form/', function (request, response) {
    ...
    fs.readFile(filePath, 'utf8', function (err, data) {
        ...
        data = data.replace(/\$OG_IMAGE/g, 'https://www.famosos.com/assets/img/favicon.png');
        data = data.replace(/\$OG_SITE_NAME/g, 'Famosos.com');
        data = data.replace(/\$OG_DESCRIPTION/g, 'Inicia sesión en Famosos.com. Reserva tu video y disfruta de experiencias únicas.');
        data = data.replace(/\$OG_VIDEO/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_SECURE_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_WITH/g, '400');
...
app.get('/auth/sign-up/email-form/', function (request, response) {
    ...
    fs.readFile(filePath, 'utf8', function (err, data) {
        ...
        data = data.replace(/\$OG_IMAGE/g, 'https://www.famosos.com/assets/img/favicon.png');
        data = data.replace(/\$OG_SITE_NAME/g, 'Famosos.com');
        data = data.replace(/\$OG_DESCRIPTION/g, 'Crea una cuenta en Famosos.com. Reserva tu video y disfruta de experiencias únicas.');
        data = data.replace(/\$OG_VIDEO/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_SECURE_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_WITH/g, '400');
...
app.get('/auth/reset-password', function (request, response) {
    ...
    fs.readFile(filePath, 'utf8', function (err, data) {
        ...
        data = data.replace(/\$OG_IMAGE/g, 'https://www.famosos.com/assets/img/favicon.png');
        data = data.replace(/\$OG_SITE_NAME/g, 'Famosos.com');
        data = data.replace(/\$OG_DESCRIPTION/g, 'Recupera la contraseña de tu cuenta de Famosos.com. Reserva tu video y disfruta de experiencias únicas.');
        data = data.replace(/\$OG_VIDEO/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_SECURE_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_WITH/g, '400');
...
app.get('/docs/terminos', function (request, response) {
    ...
    fs.readFile(filePath, 'utf8', function (err, data) {
        ...
        data = data.replace(/\$OG_TITLE/g, 'Famosos.com - Términos de servicio de usuario');
        data = data.replace(/\$OG_TYPE/g, 'website');
        data = data.replace(/\$OG_URL/g, 'https://www.famosos.com');
        data = data.replace(/\$OG_IMAGE/g, 'https://www.famosos.com/assets/img/favicon.png');
        data = data.replace(/\$OG_SITE_NAME/g, 'Famosos.com');
...
app.get('/forms/aplicar/', function (request, response) {
    ...
    fs.readFile(filePath, 'utf8', function (err, data) {
        ...
        data = data.replace(/\$OG_IMAGE/g, 'https://www.famosos.com/assets/img/favicon.png');
        data = data.replace(/\$OG_SITE_NAME/g, 'Famosos.com');
        data = data.replace(/\$OG_DESCRIPTION/g, 'Aplica como Famoso y descubre una nueva forma de conectarte con tus Fans. Crea experiencias increíbles.');
        data = data.replace(/\$OG_VIDEO/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_SECURE_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_WITH/g, '400');
...
app.get('/tendencias/', function (request, response) {
    ...
    fs.readFile(filePath, 'utf8', function (err, data) {
        ...
        data = data.replace(/\$OG_IMAGE/g, 'https://www.famosos.com/assets/img/favicon.png');
        data = data.replace(/\$OG_SITE_NAME/g, 'Famosos.com');
        data = data.replace(/\$OG_DESCRIPTION/g, 'Estos son los videos que estan siendo tendencia en Famosos.com. Reserva tu video y disfruta de experiencias únicas.');
        data = data.replace(/\$OG_VIDEO/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_SECURE_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_WITH/g, '400');
...
app.get('/docs/faqs', function (request, response) {
    ...
    fs.readFile(filePath, 'utf8', function (err, data) {
        ...
        data = data.replace(/\$OG_IMAGE/g, 'https://www.famosos.com/assets/img/favicon.png');
        data = data.replace(/\$OG_SITE_NAME/g, 'Famosos.com');
        data = data.replace(/\$OG_DESCRIPTION/g, '¿Qué es Famosos.com? Famosos es una plataforma en dónde puedes comprar video-mensajes de tus famosos favoritos. ¿Cómo puedo comprar un video?');
        data = data.replace(/\$OG_VIDEO/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_SECURE_URL/g, 'https://famosos-output-videos.s3.amazonaws.com/videos/8/143/201912030248-353316-143.mp4#t=0.5');
        data = data.replace(/\$OG_VIDEO_WITH/g, '400');
