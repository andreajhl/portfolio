...
var ERRORS = (exports.ERRORS = {
  ...
  NOT_EXPRESSION_TYPE:
    'Attribute "{0}" of <{1}> tag must be an expression, e.g. "{0}={ ... }"',
  NOT_STRING_TYPE:
    'Attribute "{0}" of <{1}> tag must be of type String, e.g. {0}="..."',
  CHOOSE_WITHOUT_WHEN:
    "<Choose> statement requires at least one <When> element!",
  CHOOSE_OTHERWISE_NOT_LAST:
    "<Otherwise> must be the last element within a <Choose> statement!",
  CHOOSE_WITH_MULTIPLE_OTHERWISE:
    "<Choose> statement allows only for one <Otherwise> block!",
  CHOOSE_WITH_WRONG_CHILDREN:
    "Only <Otherwise> and <When> are allowed child elements for <Choose>!",
});
