...
class SignInMethodsForm extends Component {
    ...
    goToSignInWithWhatsApp() {
        if (this.props.signUp) {
            history._pushRoute(PATHS.SIGN_UP_WITH_SPECIFIC_FORM_PATH.replace(":form", "whatsapp-form"))
        } else {
            history._pushRoute(PATHS.SIGN_IN_WITH_SPECIFIC_FORM_PATH.replace(":form", "whatsapp-form"))
        }
    }

    goToSignInWithCellphone() {
        if (this.props.signUp) {
            history._pushRoute(PATHS.SIGN_UP_WITH_SPECIFIC_FORM_PATH.replace(":form", "cellphone-form"))
        } else {
            history._pushRoute(PATHS.SIGN_IN_WITH_SPECIFIC_FORM_PATH.replace(":form", "cellphone-form"))
        }
    }
