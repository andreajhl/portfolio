    ...
    return(
        <div className="front">
            ...
            <div className="front_cuerpo">
                ...
                <div className="front_DivC">
                    <div className='front_DivC_hover'>
                        <img className="front_DivC_hover_img" src='https://lh3.googleusercontent.com/proxy/l800ZpCaoLRubnrlRaabL7p54eeqWVJDWyNS1soz3_hHygeEL2SODDX8Wp8Bt24E0Fiv5o789L3zQQsGAHG4fSPvrsLzuMv27o6qFFhk2j2B' alt='proyect' />
                        <div className="mostrar">
                ...
                <div className="front_DivC">
                    <div className='front_DivC_hover'>
                        <img className="front_DivC_hover_img" src='https://lh3.googleusercontent.com/proxy/l800ZpCaoLRubnrlRaabL7p54eeqWVJDWyNS1soz3_hHygeEL2SODDX8Wp8Bt24E0Fiv5o789L3zQQsGAHG4fSPvrsLzuMv27o6qFFhk2j2B' alt='proyect' />
                        <div className="mostrar">
                            <p>En la aplicacion contas con una base de 40 pokemons para empezar, podes crear los tutyos propios a traves de un formulario o buscar otros mas por nombres especifico, podes ordenar por fuerza, alfabeticamente o podes filtratlos por sus tipos o creaciones propias, podes guardarlos en favoritos y ver sus detalles tambien</p>
                        </div>
                    </div>
                    <div className="front_DivC_v">
                      <h3>App Pokemon</h3>
