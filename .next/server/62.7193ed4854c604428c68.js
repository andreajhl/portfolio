...
const CelebrityDetails = next_dynamic__WEBPACK_IMPORTED_MODULE_2___default()(() => __webpack_require__.e(/* import() */ 51).then(__webpack_require__.bind(null, "i/n7")).then(mod => mod.CelebrityDetails), {
  loadableGenerated: {
...
const CelebrityPublicContractsSectionLayout = next_dynamic__WEBPACK_IMPORTED_MODULE_2___default()(() => __webpack_require__.e(/* import() */ 52).then(__webpack_require__.bind(null, "2aTP")).then(mod => mod.CelebrityPublicContractsSectionLayout), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("2aTP")],
    modules: ["../celebrity-public-contracts-section"]
  }
});
const SimilarCelebritiesCardsSectionLayout = next_dynamic__WEBPACK_IMPORTED_MODULE_2___default()(() => __webpack_require__.e(/* import() */ 50).then(__webpack_require__.bind(null, "bASm")).then(mod => mod.SimilarCelebritiesCardsSectionLayout), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("bASm")],
    modules: ["../similar-celebrities-cards-section"]
  }
});
const HireThisCelebrityButton = next_dynamic__WEBPACK_IMPORTED_MODULE_2___default()(() => __webpack_require__.e(/* import() */ 55).then(__webpack_require__.bind(null, "RFYS")).then(mod => mod.HireThisCelebrityButton), {
  loadableGenerated: {
...
const SimilarCelebrityContractsSectionLayout = next_dynamic__WEBPACK_IMPORTED_MODULE_2___default()(() => __webpack_require__.e(/* import() */ 49).then(__webpack_require__.bind(null, "P6rR")).then(mod => mod.SimilarCelebrityContractsSectionLayout), {
  loadableGenerated: {
